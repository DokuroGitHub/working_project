...
class _ContactsPageState extends State<ContactsPage> {
  ...
  Future<void> _showMessagesPage(BuildContext context, String myUserId2) async {
    print('contacts_page, showMessagesPage, myUserId2: $myUserId2');
    Conversation? conversation = await DatabaseService().getConversationByMeAndSomeone(widget.myUser.id!, myUserId2);
    ...
    if(conversation!=null){
      ...
      Conversation x = Conversation(
        ...
        description: null,
        messageLast: null,
        members: [widget.myUser.id!, myUserId2],
        photoURL: null,
        title: null,
      );
      //TODO: add
      ...
      //TODO: add
      await DatabaseService().addParticipantToDBWithId(conversationId, widget.myUser.id!, y.toMap());
      //TODO: new
  ...
  Widget _contactItem(BuildContext context ,MyUser myUser) {
    return GestureDetector(
      onTap: (){
        print('contacts_page, _contactItem, tap myUser.name: ${myUser.name}');
        _showMessagesPage(context, myUser.id!);
      },
      child: Container(
              ...
              return ListView.builder(
                ...
                itemBuilder: (BuildContext ctx, int index) {
                  if(myUsers[index].id! != widget.myUser.id!){
                    return _contactItem(context, myUsers[index]);
                  }
                  return Container();
                },
              );
