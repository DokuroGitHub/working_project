  ...
  List<LineChartBarData> lineBarsData1(){
    ...
    for(int i=0;i<lineModel.lines.length;i++){
      LineChartBarData lineChartBarData = LineChartBarData(
        isCurved: true,
        colors: [lineBarsData1Colors[i%lineBarsData1Colors.length]],
        barWidth: 8,
        isStrokeCapRound: true,
        dotData: FlDotData(show: false),
        belowBarData: BarAreaData(show: false, colors: [lineBarsData1Colors[i%lineBarsData1Colors.length]]),
        spots: [
  ...
  List<LineChartBarData> lineBarsData2(){
    ...
    for(int i=0;i<lineModel.lines.length;i++){
      LineChartBarData lineChartBarData = LineChartBarData(
        isCurved: true,
        curveSmoothness: 0,
        colors: [lineBarsData2Colors[i%lineBarsData2Colors.length]],
        barWidth: 4,
        isStrokeCapRound: true,
        dotData: FlDotData(show: false),
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: _LineChart(lineModel: widget.lineModel, isShowingMainData: isShowingMainData),
                  ),
                ),
                const SizedBox(
                  height: 10,
