...
class HomePageForShipper extends StatefulWidget {
  const HomePageForShipper({
    Key? key,
  ...
  @override
  _HomePageForShipperState createState() => _HomePageForShipperState();
}

class _HomePageForShipperState extends State<HomePageForShipper> {
