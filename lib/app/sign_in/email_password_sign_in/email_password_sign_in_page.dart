...
import '/app/sign_in/email_password_sign_in/email_password_sign_in_model.dart';
...
class EmailPasswordSignInPage extends StatefulWidget {
  ...
  factory EmailPasswordSignInPage.withFirebaseAuth({VoidCallback? onSignedIn}) {
  ...
  void _showSignInError(EmailPasswordSignInModel model, dynamic exception) {
    showDialog<void>(
      ...
      builder: (context) => AlertDialog(
        title: Text(model.errorAlertTitle),
        content: const Text(EmailPasswordSignInStrings.resetLinkSentMessage),
        actions: <Widget>[
          ElevatedButton(
            child: const Text(EmailPasswordSignInStrings.ok),
      ...
      if (success) {
        if (model.formType == EmailPasswordSignInFormType.forgotPassword) {
          ...
          await showDialog<void>(
            context: context,
            builder: (context) => AlertDialog(
              title: const Text(EmailPasswordSignInStrings.resetLinkSentTitle),
              content: const Text(EmailPasswordSignInStrings.resetLinkSentMessage),
              actions: <Widget>[
                ElevatedButton(
                  child: const Text(EmailPasswordSignInStrings.ok),
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            const SizedBox(height: 8.0),
            ElevatedButton(onPressed: model.isLoading ? null : _submit, child: Text(model.primaryButtonText)),
            const SizedBox(height: 8.0),
            FlatButton(
